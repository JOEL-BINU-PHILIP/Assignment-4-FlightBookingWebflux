...
public class FlightServiceImpl implements FlightService {
    ...
    public Mono<Flight> addInventory(FlightInventoryRequest request) {
        ...
        if (request.getDepartureTime().isAfter(request.getArrivalTime())) {
            log.warn("Invalid time range: departure {} is after arrival {}", 
        ...
        return flightRepository
                ...
                .flatMap(existing -> {
                    log.warn("Duplicate flight found: flightNumber={}, departure={}", 
    ...
    public Flux<Flight> searchFlights(FlightSearchRequest req) {
        ...
        log.info("Searching flights from {} to {} on {}",
                req.getFromPlace(), req.getToPlace(), req.getTravelDate());
    ...
    public Mono<Flight> getFlightById(String id) {
        ...
        return flightRepository.findById(id)
                .doOnNext(f -> log.debug("Flight found: {}", f))
